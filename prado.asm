...
DEF_METEORO_MAU:						; tabela que define o meteoro mau 
    ...
    WORD		PIXEL_VERDE, 	PIXEL_VERDE, 					PIXEL_VERDE, 					PIXEL_VERDE, 					PIXEL_VERDE
	WORD		PIXEL_VERDE, 	PIXEL_PRETO, 					PIXEL_VERDE, 	PIXEL_PRETO, 					PIXEL_VERDE
    WORD		PIXEL_VERDE, 					PIXEL_PRETO, 	PIXEL_VERDE, 	PIXEL_PRETO, 	PIXEL_VERDE
   	WORD		0, 	PIXEL_VERDE, 					PIXEL_VERDE, 	PIXEL_VERDE, 					0
    WORD		0, 	0, 					PIXEL_VERDE, 					0, 					0
...
; *
; * ESPERA_NAO_TECLA - Espera até que nenhuma tecla esteja a ser pressionada
; *
